...
<body class="error-page">
    ...
    <div class="main-wrapper">
        <div class="error-box">
            ...
            <p class="h4 font-weight-normal">Our LinkedIn page is currently experiencing a technical issue, but we should be able to re-upload it on the 30th of this month once the issue has been resolved.</p>
